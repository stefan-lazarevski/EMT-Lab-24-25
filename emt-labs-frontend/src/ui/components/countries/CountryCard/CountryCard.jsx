...
import EditCountryDialog from "../CountryDialog/EditCountryDialog/EditCountryDialog.jsx";
import DeleteCountryDialog from "../CountryDialog/DeleteCountryDialog/DeleteCountryDialog.jsx";
            ...
            <Card sx={{boxShadow: 3, borderRadius: 2, p: 1}}>
                <CardContent>
                    ...
                    <Typography variant="body1"
                                sx={{textAlign: "right", fontSize: "1.25rem"}}>Continent: {country.continent}</Typography>
                </CardContent>
