...
//    List<Housing> findByFilters(String name, Category category, Long hostId, Integer numRooms);
    ...
    List<Housing> searchByName(String name);
    List<Housing> searchByCategory(Category category);
    List<Housing> searchByHost(Long hostId);
    List<Housing> searchByNumRooms(Integer numRooms);
