...
//            @Param("numRooms") Integer numRooms);
    ...
    List<Housing> findByNameContainingIgnoreCase(String name);
    List<Housing> findByCategory(Category category);
    List<Housing> findByHost_NameContainingIgnoreCaseOrHost_SurnameContainingIgnoreCase(String name, String surname);
    List<Housing> findByNumRooms(Integer numRooms);
}
